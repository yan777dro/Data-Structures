/**
 * Graphs are nonlinear interconnections between nodes.  
 * undirected graphs are node connections without implicit direction, the connections go both ways
 * directed graphs the node connections go from one point to another, for example :
 * you can traverse from A to B  but not B to A.
 */
class Graph{
